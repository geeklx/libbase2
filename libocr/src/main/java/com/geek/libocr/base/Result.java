...
public class Result {
    ...
    public String toString() {
        ...
        if (type == TYPE_CODE) {
            sb.append("二维码/条码");
        } else if (type == TYPE_ID_CARD_FRONT) {
            sb.append("身份证人头面");
        } else if (type == TYPE_ID_CARD_BACK) {
            sb.append("身份证国徽面");
        } else if (type == TYPE_BANK_CARD) {
            sb.append("银行卡");
        } else if (type == TYPE_LICENSE_PLATE) {
            sb.append("车牌");
        } else if (type == TYPE_DRIVING_LICENSE) {
            sb.append("驾驶证");
        } else {
            sb.append("未知类型（").append(type).append("）");
        }
        sb.append("\n").append(data);
        return sb.toString();
    }
