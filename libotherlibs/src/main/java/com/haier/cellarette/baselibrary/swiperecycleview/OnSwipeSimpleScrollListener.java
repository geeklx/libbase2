...
public  class OnSwipeSimpleScrollListener {
    ...
    public OnSwipeSimpleScrollListener() {
        positionHolder = new PositionHolder(new int[1], new int[1], new int[1], new int[1]);
        onScrollListener = new RecyclerView.OnScrollListener() {
            @Override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                super.onScrolled(recyclerView, dx, dy);
                SwipeBaseRecyclerView baseRecyclerView = checkRecyclerView(recyclerView);
...
//                    LogUtils.log("onScrollingFingerToTop", lastVisibleItemPositions[0] + "  " + lastVisibleItemPositions_last[0]);
    ...
    private SwipeBaseRecyclerView checkRecyclerView(RecyclerView recyclerView) {
        SwipeBaseRecyclerView baseRecyclerView = null;
        try {
            baseRecyclerView = (SwipeBaseRecyclerView) recyclerView;
        } catch (Exception e) {
    ...
    public void onFirstScrolled(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int offsetX, int offsetY) {
    }

    public void onScrollArrivedTop(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int offsetX, int offsetY) {

    }

    public void onScrollArrivedBottom(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int offsetX, int offsetY) {

    }

    public void onScrollArrivedLeft(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int offsetX, int offsetY) {
    }

    public void onScrollArrivedRight(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int offsetX, int offsetY) {
    }

    public void onScrollingFingerToBottom(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int dy, int offsetX, int offsetY) {
    }

    public void onScrollingFingerToTop(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int dy, int offsetX, int offsetY) {
    }

    public void onScrollingFingerToLeft(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int dy, int offsetX, int offsetY) {
    }

    public void onScrollingFingerToRight(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder, int dy, int offsetX, int offsetY) {
    }

    public void onItemShow(SwipeBaseRecyclerView baseRecyclerView, int position, PositionHolder positionHolder) {

    }

    public void onDragging(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder,int velocity_x, int velocity_y, int offsetX, int offsetY) {
        onShouldResumePicLoad(baseRecyclerView, positionHolder, baseRecyclerView.getVelocity_x(), baseRecyclerView.getVelocity_y(),
                baseRecyclerView.getOffsetX(), baseRecyclerView.getOffsetY());
    }

    public void onSettling(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder,
    ...
    public void onIdle(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder,
                                    int velocity_x, int velocity_y, int offsetX, int offsetY) {
        onShouldResumePicLoad(baseRecyclerView, positionHolder, baseRecyclerView.getVelocity_x(), baseRecyclerView.getVelocity_y(),
                baseRecyclerView.getOffsetX(), baseRecyclerView.getOffsetY());
    }

    public void onSettlingShouldPausePicLoad(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder,
                                             int velocity_x, int velocity_y, int offsetX, int offsetY) {
    }

    public void onShouldResumePicLoad(SwipeBaseRecyclerView baseRecyclerView, PositionHolder positionHolder,
                                      int velocity_x, int velocity_y, int offsetX, int offsetY) {
    }
