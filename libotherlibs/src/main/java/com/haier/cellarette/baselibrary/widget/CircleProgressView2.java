...
public class CircleProgressView2 extends View {
    ...
    public CircleProgressView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttribute(attrs);
    }

    private void initAttribute(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.CircleProgressView2);
        mProgressBackgroundColor = ta.getColor(R.styleable.CircleProgressView2_progressBackgroundColor, Color.GRAY);
        mProgressColor = ta.getColor(R.styleable.CircleProgressView2_progressColor, Color.BLUE);
        mProgressHeadColor = ta.getColor(R.styleable.CircleProgressView2_progressHeadColor, Color.BLUE);
        mTextColor = ta.getColor(R.styleable.CircleProgressView2_textColor, Color.WHITE);
        mStartupText = ta.getBoolean(R.styleable.CircleProgressView2_startupText, true);
        mProgressWidth = (int) ta.getDimension(R.styleable.CircleProgressView2_progressWidth, 5);
        mProgressBackgroundWidth = (int) ta.getDimension(R.styleable.CircleProgressView2_progressBackgroundWidth, 4);
        mProgressHeadRadius = (int) ta.getDimension(R.styleable.CircleProgressView2_progressHeadRadius, 10);
        mTextSize = (int) ta.getDimension(R.styleable.CircleProgressView2_textSize, 8);
        mMaxProgressValue = ta.getInt(R.styleable.CircleProgressView2_maxProgressValue, 100);
        mProgressValue = ta.getInt(R.styleable.CircleProgressView2_progressValue, 0);
    }
    ...
    private void toProgressValue(final float value, final float beforeValue) {
        ...
        mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                CircleProgressView2.this.mProgressValue = value;
                postInvalidate();
            }
        });
