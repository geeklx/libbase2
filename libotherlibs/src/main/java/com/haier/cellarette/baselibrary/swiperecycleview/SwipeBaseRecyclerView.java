...
public class SwipeBaseRecyclerView<T extends SwipeBaseRecyclerView> extends RecyclerView {
    ...
    public SwipeBaseRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public T addOnScrollListener(OnSwipeSimpleScrollListener onSimpleScrollListener) {
