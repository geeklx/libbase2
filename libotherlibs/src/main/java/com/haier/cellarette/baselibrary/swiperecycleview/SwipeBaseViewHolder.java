...
public class SwipeBaseViewHolder extends RecyclerView.ViewHolder {
    private SparseArray<View> array_view;
    private boolean isFullSpan=false;
    public SwipeBaseViewHolder(View itemView) {
        super(itemView);
    ...
    public SwipeBaseViewHolder putView(int viewId, View view){
        array_view.put(viewId,view);
        return this;
    }
...
//???????????????????????????????????????????????????????????????
    ...
    //设置View显示
    public SwipeBaseViewHolder setVisible(int res_id) {
        getView(res_id).setVisibility(View.VISIBLE);
        return this;
    }
    //设置View隐藏

    public SwipeBaseViewHolder setInVisible(int res_id) {
    ...
    public SwipeBaseViewHolder setText(int tv_id, Object text) {
    ...
    //设置TextView 前面+¥
    public SwipeBaseViewHolder setPriceText(int tv_id, Object text) {
        TextView tv = getView(tv_id);
    ...
    public SwipeBaseViewHolder setTextColor(int tv_id, int color) {
        TextView tv = getView(tv_id);
    ...
    public SwipeBaseViewHolder setBackgroundResource(int v_id, int resid) {
    ...
    public SwipeBaseViewHolder setImageBitmap(int iv_id, Bitmap bitmap) {
    ...
    public SwipeBaseViewHolder setImageResource(int iv_id, int resID) {
        ImageView view = getView(iv_id);
