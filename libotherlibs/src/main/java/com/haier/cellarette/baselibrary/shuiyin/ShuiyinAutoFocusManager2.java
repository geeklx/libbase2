...
public class ShuiyinAutoFocusManager2 implements Camera.AutoFocusCallback {

	static final String TAG = ShuiyinAutoFocusManager2.class.getSimpleName();
	...
	public ShuiyinAutoFocusManager2(Context context, Camera camera) {
		this.camera = camera;
