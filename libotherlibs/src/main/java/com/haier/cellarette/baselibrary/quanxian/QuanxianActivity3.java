 ...
 *    desc   : 权限申请演示
 */
public final class QuanxianActivity3 extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quanxian3);
        ...
        // 初始化吐司工具类
        Toaster.init(BaseApp.get(), new WhiteToastStyle());
    }
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_main_request_single_permission) {
                ...
                .request(new OnPermissionCallback() {
                    ...
                    public void onGranted(@NonNull List<String> permissions, boolean allGranted) {
                        ...
                        toast(String.format(getString(R.string.demo_obtain_permission_success_hint),
                            PermissionNameConvert.getPermissionNames(QuanxianActivity3.this, permissions)));
                    }
                });
            ...
            view.postDelayed(new Runnable() {
                ...
                @Override
                public void run() {
                    XXPermissions.with(QuanxianActivity3.this)
