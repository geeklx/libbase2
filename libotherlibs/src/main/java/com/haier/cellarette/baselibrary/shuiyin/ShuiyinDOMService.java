...
public class ShuiyinDOMService {

    public static List<ShuiyinXmlBean> getPersons(InputStream inputStream) throws Exception {
        List<ShuiyinXmlBean> persons = new ArrayList<>();
        //获取DOM解析器工厂
        ...
        for (int i = 0; i < personNodes.getLength(); i++) {
            ShuiyinXmlBean person = new ShuiyinXmlBean();
            //取得person节点元素
