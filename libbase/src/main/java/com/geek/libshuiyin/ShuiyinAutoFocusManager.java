...
public class ShuiyinAutoFocusManager implements Camera.AutoFocusCallback {

	static final String TAG = ShuiyinAutoFocusManager.class.getSimpleName();
	...
	public ShuiyinAutoFocusManager(Context context, Camera camera) {
		this.camera = camera;
